                    ...
                    <div class="form-horizontal onlineTools">
                        <div class="row row-fluid">
                            <div class="span10">
                                ...
                                <div class="controls">
                                    <input size="30" class=" input-medium" id="firewall_name" name="firewall_name" type="text">
                                </div>
                            </div>
                            <div class="span10">
                                <label class="control-label">设备IP:</label>
                                <div class="controls">
                                    <input size="30" class=" input-medium" id="firewall_ip" name="firewall_ip" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="row row-fluid">
                    ...
                    <div class="omc_table_box">
                        ...
                        <table class="table table-bordered table-striped table-head-bordered table-hover  center ">
                            ...
                            <tr>
                                ...
                                <th style="width:15%">文件采集路径</th>
                                <th style="width:15%">采集结果路径</th>
                                <th style="width:15%">操作</th>
                            </tr>
                            </thead>
                            <tbody id="basdiv"></tbody>
                        </table>
        ...
        <div class="form-horizontal onlineTools">
            <table style="margin-left:0px;border-collapse:separate;border-spacing:0px 5px;">
                <tr style="">
                    ...
                    <td style="padding-left:10px;"><input id="add_firewall_name" size="20" maxlength="20" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
                    <td style="text-align:right;padding-left:10px;">设备IP:</td>
                    <td style="padding-left:10px;"><input id="add_firewall_ip" size="30" maxlength="30" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
                </tr>
                <tr style="">
                ...
                <tr style="">
                    ...
                    <td style="text-align:right;padding-left:10px;">文件采集路径:</td>
                    <td style="padding-left:10px;"><input id="add_file_path" size="30" maxlength="30" style="width: 150px;" class="" type="text"></td>
                </tr>
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">采集结果路径:</td>
                    <td style="padding-left:10px;"><input id="add_result_path" size="30" maxlength="30" style="width: 150px;" class="" type="text"></td>
                </tr>
                <tr style="">
    ...
    <div class="mt10 display_none" id="modify_div">
        <div class="form-horizontal onlineTools">
            ...
            <table style="margin-left:0px;border-collapse:separate;border-spacing:0px 5px;">
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">设备名称:</td>
                    <td style="padding-left:10px;"><input id="modify_firewall_name" size="20" maxlength="20" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
                    <td style="text-align:right;padding-left:10px;">设备IP:</td>
                    <td style="padding-left:10px;"><input id="modify_firewall_ip" size="30" maxlength="30" disabled="disabled" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
                </tr>
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">厂家名称:</td>
                ...
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">采集结果路径:</td>
                    <td style="padding-left:10px;"><input id="modify_result_path" size="30" maxlength="30" style="width: 150px;" class="" type="text"></td>
                </tr>
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">描述:</td>
    ...
    <div class="mt10 display_none" id="detail_div">
        <div class="form-horizontal onlineTools">
            ...
            <table style="margin-left:40px;border-collapse:separate;border-spacing:0px 5px;">
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">设备名称:</td>
                    <td style="padding-left:10px;"><input id="detail_firewall_name" size="30" readonly="readonly" style="width: 150px;" class="" type="text"></td>
                    <td style="text-align:right;padding-left:10px;">设备IP:</td>
                    <td style="padding-left:10px;"><input id="detail_firewall_ip" size="30" readonly="readonly" style="width: 150px;" class="" type="text"></td>
                </tr>
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">设备型号:</td>
                ...
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">采集结果路径:</td>
                    <td style="padding-left:10px;"><input id="detail_result_path" size="30" maxlength="30" style="width: 150px;" class="" type="text"></td>
                </tr>
                <tr style="">
                    <td style="text-align:right;padding-left:10px;">描述:</td>
