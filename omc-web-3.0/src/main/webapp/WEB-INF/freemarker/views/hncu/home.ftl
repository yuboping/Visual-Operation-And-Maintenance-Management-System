<@bs.layout [
    ...
    "echarts/echarts.css",
    "lcims/hncu/layui/layui.all.js",
    "lcims/hncu/home.js",
    "lcims/hncu/jtopo.js",
     "dpl.css",
    "global.css", 
    "hncu/layui/css/layui.css",
    "hncu/iconfont/iconfont.css",
    "hncu/global.css"
] true>
<div class="main clearfix" style="background: #050a32 url(/images/hncu/bg.png) no-repeat center;width: 100%;height: 850px;">
    <div class="w75 fl">
        <div class="mian_middle">
            <div id="serverwidth" class="block" style="height:828px">
                <div class="block_title">服务器列表</div>
                <div class="ltalics_bg"><img src="/images/hncu/1.png"></div>
