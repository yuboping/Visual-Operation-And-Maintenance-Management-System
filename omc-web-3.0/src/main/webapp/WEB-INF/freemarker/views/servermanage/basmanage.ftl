<@bs.layout [
    "echarts/echarts.js",
    "lcims/servermanage/basmanage.js",
    "layer/layer.css",
    "dpl.css"
]  true true>
<!--main-->
                ...
                <div class="form-horizontal onlineTools">
                    <div class="row row-fluid">
                        <div class="span10">
                            ...
                            <div class="controls">
                                <input size="30" class=" input-medium" id="nas_name" name="nas_name" type="text">
                            </div>
                        </div>
                        <div class="span10">
                            <label class="control-label">设备IP:</label>
                            <div class="controls">
                                <input size="30" class=" input-medium" id="nas_ip" name="nas_ip" type="text">
                            </div>
                        </div>
                     </div>
                     <div class="row row-fluid">
                        <div class="span10">
                            ...
                            <div class="controls">
                                <select class="input-medium" id="nas_type" name="nas_type" >
                    ...
                    <!--    <div class="span10" style="visibility:hidden">
                            <label class="control-label"></label>
                            <div class="controls">
                                <select class="input-medium" id="nas_type_hidden" name="nas_type_hidden">
                                </select>
                            </div>
                        </div> -->
                        <div class="span4">
    ...
    <div class="form-horizontal onlineTools">
        <table style="margin-left:0px;border-collapse:separate;border-spacing:0px 5px;">
			<tr style="">
				...
				<td style="padding-left:10px;"><input id="add_bas_name" size="20" maxlength="20" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
				<td style="text-align:right;padding-left:10px;">设备IP:</td>
				<td style="padding-left:10px;"><input id="add_bas_ip" size="30" maxlength="30" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
			</tr>
			<tr style="">
...
<div class="mt10 display_none" id="modify_div">
    <div class="form-horizontal onlineTools">
        ...
        <table style="margin-left:0px;border-collapse:separate;border-spacing:0px 5px;">
			<tr style="">
				<td style="text-align:right;padding-left:10px;">设备名称:</td>
				<td style="padding-left:10px;"><input id="modify_bas_name" size="20" maxlength="20" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
				<td style="text-align:right;padding-left:10px;">设备IP:</td>
				<td style="padding-left:10px;"><input id="modify_bas_ip" size="30" maxlength="30" disabled="disabled" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
			</tr>
			<tr style="">
				<td style="text-align:right;padding-left:10px;">厂家名称:</td>
...
<div class="mt10 display_none" id="detail_div">
    <div class="form-horizontal onlineTools">
        ...
        <table style="margin-left:40px;border-collapse:separate;border-spacing:0px 5px;">
			<tr style="">
				<td style="text-align:right;padding-left:10px;">设备名称:</td>
				<td style="padding-left:10px;"><input id="detail_bas_name" size="30" readonly="readonly" style="width: 150px;" class="" type="text"></td>
				<td style="text-align:right;padding-left:10px;">设备IP:</td>
				<td style="padding-left:10px;"><input id="detail_bas_ip" size="30" readonly="readonly" style="width: 150px;" class="" type="text"></td>
			</tr>
			<tr style="">
				<td style="text-align:right;padding-left:10px;">设备型号:</td>
