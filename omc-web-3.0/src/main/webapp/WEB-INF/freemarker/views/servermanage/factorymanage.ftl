<@bs.layout [
    "echarts/echarts.js",
    "lcims/servermanage/factorymanage.js",
    "layer/layer.css",
    "dpl.css"
]  true true>
<!--main-->
                ...
                <div class="form-horizontal onlineTools">
                    <div class="row row-fluid">
                        <div class="span10">
                            ...
                            <div class="controls">
                                <input size="30" class=" input-medium" id="factory_name" name="factory_name" type="text">
                            </div>
                        </div>
	                    <div class="span4">
    ...
    <div class="form-horizontal onlineTools">
        <table style="margin-left:0px;border-collapse:separate;border-spacing:0px 5px;">
			<tr style="">
				...
				<td style="padding-left:10px;"><input id="add_factory_name" size="30" maxlength="50" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
			</tr>
			<tr style="">
				<td style="text-align:right;padding-left:10px;">厂家描述:</td>
...
<div class="mt10 display_none" id="modify_div">
    <div class="form-horizontal onlineTools">
        ...
        <table style="margin-left:0px;border-collapse:separate;border-spacing:0px 5px;">
			<tr style="">
				<td style="text-align:right;padding-left:10px;">厂家名称:</td>
				<td style="padding-left:10px;"><input id="modify_factory_name" size="30" maxlength="50" style="width: 150px;" class="" type="text"> <span class="text-danger">*</span></td>
			</tr>
			<tr style="">
				<td style="text-align:right;padding-left:10px;">厂家描述:</td>
...
<div class="mt10 display_none" id="detail_div">
    <div class="form-horizontal onlineTools">
        ...
        <table style="margin-left:40px;border-collapse:separate;border-spacing:0px 5px;">
			...
			<tr style="">
				<td style="text-align:right;padding-left:10px;">厂家描述:</td>
				<td style="padding-left:10px;" colspan="3"><input id="detail_description" readonly="readonly" size="50" style="width: 380px;" class="" type="text"></td>
			</tr>
       </table>
       <div class="row row-fluid mb10">
           <br/>
