    ...
    <div class="form-horizontal onlineTools">
        <table style="margin-left:40px;border-collapse:separate;border-spacing:0px 5px;">
			...
			<tr style="">
				...
				<td style="padding-left:10px;"><select class="" style="width: 150px;" id="add_hosttype"></select><span class="text-danger">*</span></td>
			</tr>
			<tr style="">
    ...
    <div class="form-horizontal onlineTools">
        ...
        <table style="margin-left:40px;border-collapse:separate;border-spacing:0px 5px;">
			...
			<tr style="">
				...
				<td style="text-align:right;padding-left:10px;">主机类型:</td>
				<td style="padding-left:10px;"><select class="" style="width: 150px;" id="modify_hosttype"></select> <span class="text-danger">*</span></td>
			</tr>
			<tr style="">
				<td style="text-align:right;padding-left:10px;">位置:</td>
