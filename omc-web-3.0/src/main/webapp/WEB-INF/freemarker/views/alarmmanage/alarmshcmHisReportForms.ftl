<@bs.layout [
    "echarts/echarts.js",
    "lcims/alarmmanage/alarmshcmhisreportforms.js",
    "laydate/laydate.js",
    "layer/layer.css",
    "dpl.css"
]  true true>
    ...
    <div class="form-horizontal onlineTools">
        ...
        <table style="margin-left:40px;border-collapse:separate;border-spacing:0px 5px;">
			...
			<tr style="">
				...
				<td style="padding-left:10px;" colspan="3"><input id="detail_alarmmsg" size="30" readonly="readonly" style="width: 380px;" class="" type="text"></td>
			</tr>
			<tr style="">
				<td style="text-align:right;padding-left:10px;">告警周期时间:</td>
				<td style="padding-left:10px;"><input id="detail_cycle_time" readonly="readonly" size="30" style="width: 150px;" class="" type="text"></td>
			...
			<tr style="">
				...
				<td style="padding-left:10px;" colspan="3"><textarea id="detail_alarmtext" readonly="readonly" size="50" style="width:380px;height:200px;resize:none;" class="" type="text"></textarea></td>
			</tr>
       </table>
