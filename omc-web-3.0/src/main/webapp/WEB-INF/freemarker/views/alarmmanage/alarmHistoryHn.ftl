<@bs.layout [
    "echarts/echarts.js",
    "lcims/alarmmanage/alarmhistoryHn.js",
    "layer/layer.css",
    "laydate/laydate.js",
    "dpl.css"
]  true true>
            ...
            <div class="omc_main_tab" >
                <div class="form-horizontal onlineTools">
                    ...
                    <div class="row row-fluid">
                        ...
                        <div class="span10">
                            <label class="control-label" style="padding-top: 0px;">告警类别:</label>
                            <div class="controls">
                                <select class="input-medium" id="query_alarmtype" name="querymodule">
                                    <option value="">请选择</option>
                                </select>
                            </div>
                        </div>
