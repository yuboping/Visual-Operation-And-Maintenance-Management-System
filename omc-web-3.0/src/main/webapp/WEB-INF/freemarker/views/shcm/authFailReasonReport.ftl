<@bs.layout [
    "echarts/echarts.js",
    "lcims/shcm/authFailReasonReport.js",
    "layer/layer.css",
    "laydate/laydate.js",
    "dpl.css",
        ...
        <div>
            ...
            <div class="omc_main_tab" >
                ...
                <div class="omc_table_box">
                    <div class="mb10 clearfix">
                        ...
                        <table class="table table-bordered table-striped table-head-bordered table-hover  center ">
                            <thead>
                                <tr>
                                    <th style="width:15%">统计时间</th>
                                    <th style="width:15%">宽带认证请求数</th>
                                    <th style="width:15%">宽带认证成功数</th>
                                    <th style="width:15%">未注册帐号</th>
                                    <th style="width:15%">密码错误</th>
                                    <th style="width:15%">用户加锁</th>
                                    <th style="width:15%">限时上网</th>
                                    <th style="width:15%">vlan错误</th>
                                    <th style="width:15%">唯一性拒绝</th>
                                </tr>
                            </thead>
                ...
                <div  style="width:100%;height:370px;margin-right:10px;padding:15px 0;padding-right:9px;" id="chartdiv">
                    <div style="width:100%;height:90%;background: #fff;border:0px solid #ebebea;" id="authFailReasonChartShow">
