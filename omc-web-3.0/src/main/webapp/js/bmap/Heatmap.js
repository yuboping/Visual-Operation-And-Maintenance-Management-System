...
(function() {
    ...
    HeatmapOverlay.prototype.draw = function() {
        ...
        if (this.latlngs.length > 0) {
            ...
            while (len--) {
                ...
                roundData[this.conf.valueField]=this.latlngs[len].c;
                d.data.push(roundData);
            }
    ...
    HeatmapOverlay.prototype.setDataSet = function(data) {
        ...
        while (dlen--) {
            ...
            mdate[this.conf.valueField]=d[dlen][this.conf.valueField];
            mapdata.data.push(mdate);
        }
