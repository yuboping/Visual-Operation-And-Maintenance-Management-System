	...
	function alarmList(){
		...
		$.ajax({
	        ...
	        success: function (data) {
	        	var table="<tr><td style=\"text-align: left;margin:5px 10px;font-size: 14px;\">告警对象</td><td style=\"text-align: left;margin:5px 10px;font-size: 14px;\">告警信息</td><td style=\"text-align: left;margin:5px 10px;font-size: 14px;\">告警时间</td></tr>";
	    		var maintable=$("#maintable")
	    		$.each(data,function(i,alarmbean){
	    			var urlr = alarmbean.url.replace(/\\/, '/');
	    			table+="<tr onclick=\"location.href = '"+urlr+"'\" style=\"\">";
	    			...
	    			table+="<a href=\""+alarmbean.url+"\" title=\""+alarmbean.dimension1Name+"\" >    "+alarmbean.dimension1Name+"</a>"
	    			table+="</td>"
	    			table+="<td style=\"text-align: left;margin:5px 10px;\">";
	    			table+="<a href=\""+alarmbean.url+"\" title=\""+alarmbean.alarmMsg+"\" >    "+alarmbean.alarmMsg+"</a>"
	    			table+="</td>"
	    			table+="<td style=\"text-align: left;margin:5px 10px;\">";
	    			table+="<a href=\""+alarmbean.url+"\" title=\""+alarmbean.lastTime.substr(0,19)+"\" >    "+alarmbean.lastTime.substr(0,16)+"</a>"
	    			table+="</td>"
	    		    table+="</tr>"
	        	})
