...
require(['jquery','layer','laypage','resizewh','checkbox','stringutil'],
        ...
        resizewh.resizeBodyH($("#hostmetricmanage"));
        $("#query_div").hide();
        initChildrenMenu();
        butBindFunction();
...
//                initQueryCondition();
        ...
        function updateHostMetric(type){
            ...
            message="是否解绑数据？";
            var url = "/view/class/system/hostmetricmanage/unbindHostMetric";
            if(type=="publish"){
                url = "/view/class/system/hostmetricmanage/publishHostMetric";
                message = "是否下发数据？";
            }
            ...
            layer.confirm(message, {
                ...
                layer.closeAll();
                loadingwait();
                var data = {hostMetricids:hostMetricids};
                 loadingwait();
                $.ajax({
                    type: "post",
        ...
        function deleteHostMetric(){
            ...
            var hostMetricids=arr.toString();
            message="是否删除数据？";
            var url = "/view/class/system/hostmetricmanage/deleteHostMetric";
            layer.confirm(message, {
                closeBtn:0,
                title: '询问',
                btn: ['确认','取消'] //按钮
        ...
        function modifyHostMetricShow(){
            ...
            $.ajax({
                type: "post",
                url: "/view/class/system/hostmetricmanage/query/singleinfoState?random=" + Math.random(),
                data: data,
                cache: false,
                async: false, 
                dataType: "json",
                success: function (result) {
                    ...
                    if(result.opSucc){
                        ...
                        $.ajax({
                            type: "post",
                            url: "/view/class/system/hostmetricmanage/query/singleinfo?random=" + Math.random(),
                            data: data,
                            cache: false,
                            async: false, 
                            dataType: "json",
        ...
        function modifyInfo(){
            ...
            if(stringutil.checkString('modify_script_param',script_param,'采集脚本参数长度不能超过256位!',256))
                return;
            loadingwait();
            var data= {id:id,script:script,script_param:script_param,cycle_id:cycle_id,script_return_type:script_return_type};
            $.getJSON("/view/class/system/hostmetricmanage/modify?random=" + Math.random(),data, function(result) {
                layer.closeAll();
                checkbox.cleanArray();
        ...
        function bindDataSubmit(){
            ...
            var url = "/view/class/system/hostmetricmanage/getbindOperate";
        ...
        function queryOperateModuleChange(){
            ...
            var url = "/view/class/system/hostmetricmanage/getSourceList";
             var data = {operatetype:operatetype};
             loadingwait();
            $.ajax({
                type: "post",
        ...
        function queryHostMetricInfoChange(){
            ...
            if(operateid==null || operateid=="")
                return;
            //查询数据
            var url = "/view/class/system/hostmetricmanage/getHostMetricConfigInfo";
      ...
      //加载查询内容
        function loadOptRecord(pageNumber){
            ...
            $.getJSON("/view/class/system/hostmetricmanage/query?random=" + Math.random(),data, function(result) {
                layer.close(layer_load);
                resetPage(result);
            });
        }
