 ...
 */
@Controller
@RequestMapping(value = "/view/class/system/shcmalarmhisquery")
public class SHCMAlarmHisQueryView extends BaseController{

    private static final Logger LOG = LoggerFactory.getLogger(SHCMAlarmHisQueryView.class);

    @Autowired
    private AlarmService alarmService;

    @Autowired
    private AlarmRuleManageService alarmRuleManageService;
    ...
    public String moduleMonitor(HttpServletRequest request, HttpSession session, Model model) {
        ...
        return "alarmmanage/alarmshcmHisReportForms";
    }
    ...
    @ResponseBody
    public List<MdAlarmHisInfo> queryDetailHost(HttpServletRequest request) {
        String id = request.getParameter("id");
        List<MdAlarmHisInfo> alarmHisInfoList = alarmService.getDetailAlarmHisInfo(id);
        return alarmHisInfoList;
    }
