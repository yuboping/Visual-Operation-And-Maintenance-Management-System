 ...
 */
@Controller
@RequestMapping(value = "/view/class/system/alarmquery")
public class AlarmQueryView extends BaseController{

    private static final Logger LOG = LoggerFactory.getLogger(AlarmQueryView.class);
    ...
    public String moduleMonitor(HttpServletRequest request, HttpSession session, Model model) {
        ...
        return "alarmmanage/alarmHistory";
    }
