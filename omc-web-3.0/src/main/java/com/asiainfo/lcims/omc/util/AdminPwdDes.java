...
public class AdminPwdDes {
    private final static String KEY1 = "luohuawuyin";
    private final static String KEY2 = "lcims";
    private final static String KEY3 = "omc";
    ...
    public String strEnc(String data) {
        String str = this.strEnc(data, KEY1, KEY2, KEY3);
        return str;
    }
    ...
    public String strDec(String data) {
        String str = this.strDec(data, KEY1, KEY2, KEY3);
        return str;
    }
