...
public class DbDateFormatReplaceUtil {
    ...
    public static void main(String[] args) {
        ...
        String result = mkReplaceSqlStr(sql, date);
        System.out.println(result);
    }

    public static String mkReplaceSqlStr(String sql, LocalDate date) {
        ...
        nodeIndexRepList = cvDateStrToReplaceInfo(nodeIndexRepList, date);
